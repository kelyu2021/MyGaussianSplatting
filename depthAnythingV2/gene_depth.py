...
def generate_depth_maps(input_dir: str, output_dir: str,
    ...
    for i, img_path in enumerate(paths):
        ...
        # Remove red, orange, yellow, and pink pixels via HSV thresholding
        hsv = cv2.cvtColor(depth_color, cv2.COLOR_BGR2HSV)
        mask_red1   = cv2.inRange(hsv, (0, 70, 50), (10, 255, 255))
        mask_red2   = cv2.inRange(hsv, (160, 70, 50), (180, 255, 255))
        mask_orange = cv2.inRange(hsv, (10, 70, 50), (25, 255, 255))
        mask_yellow = cv2.inRange(hsv, (25, 70, 50), (35, 255, 255))
        mask_pink   = cv2.inRange(hsv, (130, 20, 50), (165, 255, 255))
        color_mask = mask_red1 | mask_red2 | mask_orange | mask_yellow | mask_pink
        depth_color[color_mask > 0] = 0
